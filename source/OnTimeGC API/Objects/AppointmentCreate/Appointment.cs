...
namespace OnTimeGC_API.Objects
{
    ...
    public class Appointment
    {
        ...
        public Appointment(string userId, DateTime startDT, DateTime endDT, string subject, string location, string[] categories, bool privat, bool available, string body)
        {
            this.UserID = UserID;
