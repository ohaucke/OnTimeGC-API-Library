...
{
    [DataContract]
    internal class UsersAllResult : Base
    {
        [DataMember(Name = "UsersAll")]
        internal List<UsersAllItem> Items { get; set; }
    }

    [DataContract]
    public class UsersAllItem
    {
        [DataMember(Name = "ID")]
        ...
        public UsersAllTyp Type { get; set; }  // 1 = mensch | 2 = room
